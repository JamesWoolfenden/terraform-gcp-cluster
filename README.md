...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_boot_disk_kms_key"></a> [boot\_disk\_kms\_key](#input\_boot\_disk\_kms\_key) | Customer-managed KMS key for node pool boot disk encryption (full resource name) | `string` | n/a | yes |
...
| <a name="input_location"></a> [location](#input\_location) | The GCP location (region or zone) | `string` | n/a | yes |
| <a name="input_maintenance_window"></a> [maintenance\_window](#input\_maintenance\_window) | The daily maintenance start time in HH:MM format | `string` | `"00:30"` | no |
...
| <a name="input_resource_labels"></a> [resource\_labels](#input\_resource\_labels) | Resource labels to apply to the cluster | `map(any)` | <pre>{<br/>  "createdby": "terraform",<br/>  "module": "terraform-gcp-cluster"<br/>}</pre> | no |
| <a name="input_security_group"></a> [security\_group](#input\_security\_group) | Google Workspace group email for GKE RBAC via authenticator\_groups\_config. Leave empty to disable. | `string` | `""` | no |
| <a name="input_subnetwork"></a> [subnetwork](#input\_subnetwork) | The subnetwork to use | `any` | n/a | yes |
| <a name="input_zones"></a> [zones](#input\_zones) | The available GCP compute zones | `any` | n/a | yes |

## Outputs

| Name | Description |
| ---- | ----------- |
| <a name="output_cluster"></a> [cluster](#output\_cluster) | The GKE cluster resource. |
| <a name="output_node_pool"></a> [node\_pool](#output\_node\_pool) | The GKE node pool resource. |
| <a name="output_service_account"></a> [service\_account](#output\_service\_account) | The service account used by the GKE cluster. |
